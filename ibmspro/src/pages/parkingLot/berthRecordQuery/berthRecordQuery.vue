    ...
    <div class="berth-record-query">
        <div class="search-condition">
            <el-row>
                ...
                <el-col :span="6">
                    <div class="condition-three condition">
                        <div class="tip-span margin-top-bottom">停车状态</div>
                        <el-select v-model="parkingStatus" placeholder="请选择" size="small" style="width:90%">
                            <el-option
                            v-for="item in parkingStatusOptions"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value">
                            </el-option>
            ...
            <el-row>
                ...
                <el-col :span="6">
                    <div class="condition-three condition">
                        <div class="tip-span margin-top-bottom">楼层</div>
                        <el-select v-model="floor" placeholder="请选择" size="small" style="width:90%">
                            <el-option
            ...
            <el-row type="flex" justify="center">
                <el-col :span=23>
                    <el-table :data="tableData" border style="width: 100%" height="600" max-height='600'>
                        ...
                        <el-table-column prop="tParkingNumber" label="车位号"></el-table-column>
                        <el-table-column prop="tParkingStatus" label="停车状态"></el-table-column>
                        <el-table-column prop="tLeaveTime" label="停车/离开时间"></el-table-column>
                        <el-table-column prop="tParkingLot" label="停车库"></el-table-column>
                        <el-table-column prop="tFloor" label="楼层"></el-table-column>
                        <el-table-column prop="tSnapshotSpace" label="车位抓拍图">
                            <template>
                                <el-image
                                    src=";;"
                                    fit="fit">
